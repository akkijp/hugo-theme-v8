    ...
    Hatena.BookmarkWidget = new function () {
        ...
        var createDiv = function (callbackId, num, div) {
            ...
            var newdiv = $E('div', null,
              $E('div', {className: theme.title },
                $E('a', {href: 'http://b.hatena.ne.jp/entrylist?url='+c.url+'&sort='+c.sort },
                  $E('img', {src: '/hatena/images/favicon.gif', valign: 'bottom' }),
                  c.title
                )
              ),
            ...
            if(div) {
                ...
                newElement.id = 'hatena-bookmark-widget'+callbackId;
                newElement.className = themetable.base + ' ' + theme.wrapper;
                if(width > 0){
                    newElement.style.cssText = "+width: "+width+"px;";
                }
        ...
        var createRequest = function(id) {
            ...
            return function () {
                var request = 'https://api.hackerslog.net/entrylist-json.php?' + [
